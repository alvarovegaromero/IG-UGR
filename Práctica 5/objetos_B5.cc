...
void _base::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	...
	superior_conector.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
}
...
void _arma::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	...
	canon_abajo.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	//draw(modo, 0.8, 0, 1, r2, g2, b2, grosor);

		glPushMatrix();
		glTranslatef(2,0,0);
		canon_arriba.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		//draw(modo, 0.8, 0, 1, r2, g2, b2, grosor);
		glPopMatrix();
	...
	une_canones.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	//draw(modo, 0.5, 0.1, 1, r2, g2, b2, grosor);
	glPopMatrix();
}
...
void _cabina::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	...
	//Ponemos color rojo
	asiento.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	//draw(modo, 1, 0, 0, r2, g2, b2, grosor);
	glPopMatrix();

	glPushMatrix();
	glScalef(0.1, 0.5, 0.5);
	glTranslatef(1.75,0.5,-0.5);
	espalda_asiento.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	//draw(modo, 1, 0, 0, r2, g2, b2, grosor);
	glPopMatrix();
...
void _nave::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	...
	glScalef(0.1,1,1);
		...
		ala_izq.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		//draw(modo, 0,0,0, 0.6, 0.6, 0.6, grosor);
		glPopMatrix();
	...
	glRotatef(90,0,0,1);
	glTranslatef(2,0,0);
	une_alas.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	//draw(modo, 0.6,0.6,0.6, 0, 0, 0, grosor);
	glPopMatrix();
...
// poner if else antes del draw de cada pieza.
...
//////////////////////////////PATAS/////////////////////////////
	...
	glPushMatrix();
	glTranslatef(-0.5, 0, 0.5);
	if (activo[0]==1) pata_delantera_izq.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
	else pata_delantera_izq.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-0.5, 0, -0.5);
	if (activo[1]==1) pata_delantera_dcha.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
	else pata_delantera_dcha.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(0.5, 0, 0.5);
	if (activo[2]==1) pata_trasera_izq.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
	else pata_trasera_izq.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(0.5, 0, -0.5);
	if (activo[3]==1) pata_trasera_dcha.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
	else pata_trasera_dcha.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
...
glRotatef(giro_base, 0, 1, 0);
	...
	if (activo[4]==1) base.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
	else base.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
...
////////////////////////CABINA/////////////////////////////////
	...
	glRotatef(giro_cabina, 0, 0, 1);
		...
		if (activo[5]==1) cabina.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
		else cabina.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
...
///////////////////////ARMAS////////////////////////////////////
		...
		glRotatef(giro_arma, 0, 1, 0);
			...
			glScalef(0.5,0.25,0.5);
				...
				if (activo[6]==1) arma_izq.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
				else arma_izq.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
				glPopMatrix();

				glPushMatrix();
				glTranslatef(-1.25,4.25,-1.15);
				if (activo[7]==1) arma_dcha.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
				else arma_dcha.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
				glPopMatrix();
...
/////////////////////ESCUDOS////////////////////////////////////
	...
	glRotatef(giro_escudo_izq,0,1,0);
			...
			if (activo[8]==1) escudo_izq.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			else escudo_izq.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
			glPopMatrix();
		...
		glRotatef(giro_escudo_dcha,0,1,0);
			...
			glRotatef(-45,0,1,0);
			glTranslatef(-0.7,1,-0.1);
			if (activo[9]==1) escudo_dcha.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			else escudo_dcha.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
			glPopMatrix();
...
if (activo[10]==1) nave.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
else nave.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
glPopMatrix();
	/////////////////////////////////////////////////////////////////
}

//metodo seleccion es lo mismo que el draw pero los draws tienen SELECT, c,c,c,c,c,c,1)
// nota, antes de cada draw hay que cambiar el valor de c
void _torreta::seleccion()
{
	//////////////////////////////PATAS/////////////////////////////
	int c;
		...
		glPushMatrix();
		glTranslatef(-0.5, 0, 0.5);
		pata_delantera_izq.draw(SELECT, c,c,c,c,c,c, 1);
		glPopMatrix();

		c=color_selec[0][1];
		glPushMatrix();
		glTranslatef(-0.5, 0, -0.5);
		pata_delantera_dcha.draw(SELECT, c,c,c,c,c,c, 1);
		glPopMatrix();

		c=color_selec[0][2];
		glPushMatrix();
		glTranslatef(0.5, 0, 0.5);
		pata_trasera_izq.draw(SELECT, c,c,c,c,c,c, 1);
		glPopMatrix();

		c=color_selec[0][3];
		glPushMatrix();
		glTranslatef(0.5, 0, -0.5);
		pata_trasera_dcha.draw(SELECT, c,c,c,c,c,c, 1);
		glPopMatrix();
	...
	glRotatef(giro_base, 0, 1, 0);
		...
		glScalef(1.5,0.5,1.5);
		glTranslatef(0,0.40,0);
		base.draw(SELECT, c,c,c,c,c,c, 1);
		glPopMatrix();
	...
	////////////////////////CABINA/////////////////////////////////
		...
		glRotatef(giro_cabina, 0, 0, 1);
			...
			glTranslatef(0,0.2+0.5,0);
			c=color_selec[0][5];
			cabina.draw(SELECT, c,c,c,c,c,c, 1);
			glPopMatrix();
	...
	///////////////////////ARMAS////////////////////////////////////
			...
			glRotatef(giro_arma, 0, 1, 0);
				...
				glScalef(0.5,0.25,0.5);
					...
					glTranslatef(-1.25,4.25,1.15);
					c=color_selec[0][6];
					arma_izq.draw(SELECT, c,c,c,c,c,c, 1);
					glPopMatrix();

					glPushMatrix();
					glTranslatef(-1.25,4.25,-1.15);
					c=color_selec[0][7];
					arma_dcha.draw(SELECT, c,c,c,c,c,c, 1);
					glPopMatrix();
	...
	/////////////////////ESCUDOS////////////////////////////////////
		...
		glRotatef(giro_escudo_izq,0,1,0);
				...
				glTranslatef(-0.7,1,0.1);
				c=color_selec[0][8];
				escudo_izq.draw(SELECT, c,c,c,c,c,c, 1);
				glPopMatrix();
			...
			glRotatef(giro_escudo_dcha,0,1,0);
				...
				glTranslatef(-0.7,1,-0.1);
				c=color_selec[0][9];
				escudo_dcha.draw(SELECT, c,c,c,c,c,c, 1);
				glPopMatrix();
	...
	glTranslatef(0,2.5,-5);
	c=color_selec[0][10];
	nave.draw(SELECT, c,c,c,c,c,c, 1);
	glPopMatrix();
		/////////////////////////////////////////////////////////////////
}

//iluminacion suave y plana no tiene parametros. Habria que hacer algun cambio para permitir seleccion en estos modos
// o cuando seleccione, que me la pinte en modo fijo - arista por ejemplo.

//mejor segunda opcion
//if (activo[0]==1) chasis.draw(EDGES, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
